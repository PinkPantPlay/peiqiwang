    ...
    function inText(stream, state) {
        ...
        if (ch == "<") {
            if (stream.eat("!")) {
                ...
                else if (stream.match("--")) return chain(inBlock("message", "-->"));
...
CodeMirror.defineMode("css", function(config) {
    ...
    return {
        ...
        token: function(stream, state) {
            ...
            else if (context == "{" && type != "message") state.stack.push("rule");
            return style;
        },
